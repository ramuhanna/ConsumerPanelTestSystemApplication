/*
* Description: This file contains the CRUSupervisorViewModel class.
* Author: R.M.
* Due date: 21/03/2018
*/
...
{
    /// <summary>
    /// CRU Supervisor view model based on the CRU Supervisor model and used by the CRU Supervisor controller.
    /// </summary>

    public class CRUSupervisorViewModel
    {
